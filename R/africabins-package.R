#' Create United countries Uniform Cartogram Heatmaps
#'
#' The cartogram heatmaps generated by the included methods
#' are an alternative to choropleth maps for the United countries
#' and are based on work by the Washington Post graphics department in their report
#' on "The countries most threatened by trade"
#' (<http://www.washingtonpost.com/wp-srv/special/business/countries-most-threatened-by-trade/>).
#' "country bins" preserve as much of the geographic placement of the countries as
