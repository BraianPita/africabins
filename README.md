...
alternative to choropleth maps for the African continent and are based on
work by boB Rudis (https://github.com/hrbrmstr).
“Africa bins” preserve as much of the geographic placement of the countries
...
``` r
install.packages("africabins") # NOTE: CRAN version is 1.2.2
# or
...
# or
remotes::install_github("BraianPita/africabins")
```
